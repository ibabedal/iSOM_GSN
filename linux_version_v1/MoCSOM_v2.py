...
#    num = 30
    ...
    path = pathlib.Path().absolute()
    path = str(path)
    src_2A = path + '/training/34'
    dst_2A =  path + '/test/34'

    src_2B =  path + '/training/43'
    dst_2B =  path + '/test/43'
    
    src_3A =  path + '/training/45'
    dst_3A =  path + '/test/45'
...
def apply_CNN():
    ...
    classifier.add(Dense(3, activation = 'softmax')) # catgorical 
    # SET METRICS 
...
def delete_recreate_dirStructure():
    ...
    path = pathlib.Path().absolute()
    path = str(path)
    src_C1 = path + '/training/34'
    dst_C1 =  path + '/test/34'

    src_C2 =  path + '/training/43'
    dst_C2 =  path + '/test/43'
    
    src_C3 =  path + '/training/45'
    dst_C3 =  path + '/test/45'
...
if __name__ == "__main__":  
 ...
 #   print("POS = " , pos)
    print("Starting the creating of images ... please wait ..")
